...
public partial class login : System.Web.UI.Page
{
    ...
    protected void btn_login_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            {
               // SqlConnection con = new SqlConnection("Data Source = DELL - PC; Initial Catalog = onlineexam; Integrated Security = True");
               // SqlDataAdapter da = new SqlDataAdapter("spUserslogin", con);
